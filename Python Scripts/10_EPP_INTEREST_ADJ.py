...
,TXN_AMT
FROM
 DATA_ANALYTICS.PL_TXN_DETAILS
WHERE
 ACCT_SEQ_NUM = 0 AND
 TXN_TRANS_CD = '0162' AND
 (MERCH_NM = 'EPP INTEREST ADJUST' OR
  MERCH_NM = 'AJUST INT�R�TS PPE') AND
 TXN_POSTED_DT BETWEEN DATE_TRUNC('MONTH', NOW() - INTERVAL '1 DAY')
...
output_path = output_dir / f"EPP_INTEREST_ADJUSTMENTS_{report_date_str}.xlsx"
...
expected_files = [
    f"EPP_INTEREST_ADJUSTMENTS_{report_date_str}.xlsx"
]
